...
public var publications: [Post] = [
    ...
    Post(author: "cat", image: "second_post", description: "My second publication", likes: 5, views: 98),
    Post(author: "Surprised cat", image: "third_post", description: "My third publication", likes: 7, views: 45),
    Post(author: "cat", image: "fourth_post", description: "My fourth publication", likes: 3, views: 20),
]
